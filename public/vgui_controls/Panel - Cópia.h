...
public:
	...
	virtual bool LookupElementBounds( const char, int&, int&, int&, int& ) { return false; }
...
private:
	...
	virtual void GetSizerMinimunSize( int& x, int& y ) {}
	virtual void GetSizerClientArea( int& x1, int& y1, int& x2, int& y2 ) {}
