...
#define MAX_PLAYERMODELINFO_STRING 256
#define MAX_PLAYER_MODELS 10
...
public:
	...
	void Precache();
	void AddModel( char* szModel );
	void Reset();

public:
	char m_szPlayerModels[ MAX_PLAYER_MODELS ][ MAX_PLAYERMODELINFO_STRING ];
	char m_szPlayerModelsName[ MAX_PLAYER_MODELS ][ MAX_PLAYERMODELINFO_STRING ];
	char m_szCTArmsModel[ MAX_PLAYERMODELINFO_STRING ];
	char m_szTerroristArmsModel[ MAX_PLAYERMODELINFO_STRING ];
	char m_szMapName[ MAX_PLAYERMODELINFO_STRING ];

	int m_iCTPlayerModels;
	int m_iTerroristPlayerModels;
	int m_iPlayerModels;

	int Pad[ 2 ];
};

extern PlayerModelInfo g_PlayerModelInfo;
