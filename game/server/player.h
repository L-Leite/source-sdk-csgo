...
public:
	...
	virtual void			PlayerUnknown01( int a1, int a2 );
	...
	virtual void			SpecLerpToPosition( const Vector &origin, const QAngle &angles, float lerp );
	...
	virtual const QAngle& GetViewPunchAngle();
...
public:							   	
	...
	Vector SomethingToDoWithPosition;
...
protected:
	...
	unsigned char m_uCameraManGraphs; // Probably uchar
...
protected:
	...
	uint8_t	PlayerPad06[ 0x10 ]; // Prob placed wrong again, but idk where currentcommand is
...
private:
	...
	uint8_t	PlayerPad08[ 0x14 ]; // It could be m_SimulatedByThisPlayer, but then why won't they use the other prediction stuff? fuck
