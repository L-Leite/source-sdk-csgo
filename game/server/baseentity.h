...
public:
	...
	virtual int OnNewModel() { return 0; }
...
protected:
	...
	// Valve releases a release build of csgo
/*#ifdef _DEBUG
...
//	const QAngle&	GetAbsAngularVelocity( ) const;
	...
	void					EmitSound( const char* soundname, CBaseEntity* entityAgainForSomeReason );
...
public:
	...
	// CHECK OFFSETS FOR THESE ASWELL
...
public:						 
	...
	bool m_bSpotted;
	uint8_t EntityPad05[ 0x3 ];

	bool m_bSpottedByMask;
	uint8_t EntityPad06[ 0xF ];
