...
#include "..\..\src\dlls\shared\FindPattern.h"
...
ConCommand::ConCommand( const char *pName, FnCommandCallback_t callback, const char *pHelpString /*= 0*/, int flags /*= 0*/, FnCommandCompletionCallback completionFunc /*= 0*/ )
{
	...
	/*using fn_t = void( __thiscall* )( ConCommand*, const char*, FnCommandCallback_t, const char*, int, FnCommandCompletionCallback );
	...
	pFn( this, pName, callback, pHelpString, flags, completionFunc );*/
}
